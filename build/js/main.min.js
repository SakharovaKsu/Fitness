...
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
...
var getSlider = function getSlider() {
  ...
  var sliderCatalog = new Swiper('.trainers-page__swiper', {
  ...
  // eslint-disable-next-line no-unused-vars
  var sliderReviews = new Swiper('.reviews__box', {
    direction: 'horizontal',
    grabCursor: true,
    loop: false,
    slidesPerView: 1,
...
var initTabs = function initTabs(e) {
  if (!tab) {
    return;
  }
...
tabsBtn.forEach(function (button) {
  return button.addEventListener('click', initTabs);
});
