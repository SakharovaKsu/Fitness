...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_player__WEBPACK_IMPORTED_MODULE_4__["playVideo"])();
...
var getSlider = function getSlider() {
  if (document.querySelector('.trainers-page__swiper')) {
    var coachesSwiper = document.querySelector('.trainers-page__swiper');
    var coachesSwiperWrapper = document.querySelector('.trainers-page__swiper-wrapper');
    var coachesButtons = document.querySelectorAll('.trainers-page__button');
    ...
    var swiper = new Swiper('.trainers-page__swiper', {
...
var initPlayer = function initPlayer() {
  ...
  window.onYouTubePlayerAPIReady = function () {
    ...
    var youtubePlayer = new YT.Player(youtubeElement.id, {
      events: {
