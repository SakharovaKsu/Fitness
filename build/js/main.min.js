...
/* harmony import */ var _modules_init_tab__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-tab */ "./js/modules/init-tab.js");
/* harmony import */ var _modules_init_player__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-player */ "./js/modules/init-player.js");
/* harmony import */ var _modules_get_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/get-slider */ "./js/modules/get-slider.js");
/* harmony import */ var _modules_scroll_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scroll-page */ "./js/modules/scroll-page.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll_page__WEBPACK_IMPORTED_MODULE_5__["scrollPage"])();
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_player__WEBPACK_IMPORTED_MODULE_3__["initPlayer"])();
    Object(_modules_get_slider__WEBPACK_IMPORTED_MODULE_4__["getSlider"])();
...
/* harmony import */ var _load_script__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./load-script */ "./js/modules/load-script.js");

var initPlayer = function initPlayer() {
  var containerElement = document.querySelector('[data-video]');
  if (!containerElement) {
    return;
  }
  var linkElement = containerElement.querySelector('[data-control]');
  var youtubeElement = containerElement.querySelector('[data-youtube]');
  ...
  Object(_load_script__WEBPACK_IMPORTED_MODULE_0__["loadScript"])('https://www.youtube.com/player_api', function () {
    window.onYouTubePlayerAPIReady = function () {
      var youtubePlayer = new window.YT.Player(youtubeElement.id, {
        events: {
...
/*!********************************!*\
  !*** ./js/modules/init-tab.js ***!
  \********************************/
/*! exports provided: initTab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTab", function() { return initTab; });
var tab = document.querySelector('.tab');
var tabsBtn = document.querySelectorAll('[data-tab-button]');
var tabsContent = document.querySelectorAll('[data-tab-content]');
var initTab = function initTab(e) {
  tabsContent.forEach(function (container) {
  ...
  var activeTab = tab.querySelector("[aria-label=\"".concat(id, "\""));
  activeTab.classList.remove('is-hidden');
};
if (tab) {
  tabsBtn.forEach(function (button) {
    return button.addEventListener('click', initTab);
  });
}
...
var loadScript = function loadScript(src, onLoad, callback) {
